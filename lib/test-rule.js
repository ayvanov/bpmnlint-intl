...
import { isArray, isObject, isFunction } from "min-dash";
 ...
 */
export default function testRule({ moddleRoot, rule }) {
  ...
  const enter =
    "enter" in check ? check.enter : isFunction(check) ? check : undefined;
